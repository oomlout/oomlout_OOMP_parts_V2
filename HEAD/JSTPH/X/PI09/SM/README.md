...
* [RPH09S > JST PH (2 mm) 9 Pin Header (SMD)](#rph09s--jst-ph-2-mm-9-pin-header-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RPH09S > JST PH (2 mm) 9 Pin Header (SMD)
...
- Short Link: [http://oom.lt/RPH09S](http://oom.lt/RPH09S)
...
[(Aliexpress) ](https://www.aliexpress.com/wholesale?SearchText=1117JST+PH+2+mm+9+Pin+Header+SMD)&nbsp;&nbsp;&nbsp;[(Avnet) ](https://www.avnet.com/shop/us/search/JST+PH+2+mm+9+Pin+Header+SMD)&nbsp;&nbsp;&nbsp;[(Digikey) ](https://www.digikey.co.uk/en/products/result?s=JST+PH+2+mm+9+Pin+Header+SMD)&nbsp;&nbsp;&nbsp;[(LCSC) ](https://www.lcsc.com/search?q=JST+PH+2+mm+9+Pin+Header+SMD)&nbsp;&nbsp;&nbsp;[(Farnell) ](https://uk.farnell.com/search?st=JST+PH+2+mm+9+Pin+Header+SMD)&nbsp;&nbsp;&nbsp;[(Mouser) ](https://www.mouser.com/c/?q=JST+PH+2+mm+9+Pin+Header+SMD)&nbsp;&nbsp;&nbsp;
## MPNs
...
|qrCode<br>[![](https://raw.githubusercontent.com/oomlout/oomlout_OOMP_parts_V2/main/HEAD/JSTPH/X/PI09/SM/qrCode_140.png)](https://github.com/oomlout/oomlout_OOMP_parts_V2/tree/main/HEAD/JSTPH/X/PI09/SM/qrCode.png)||||
| :---: | :---: | :---: | :---: |
...
|Hex ID (short code)|hexID|RPH09S|
