...
* [RPH16S > JST PH (2 mm) 16 Pin Header (SMD)](#rph16s--jst-ph-2-mm-16-pin-header-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RPH16S > JST PH (2 mm) 16 Pin Header (SMD)
...
- Short Link: [http://oom.lt/RPH16S](http://oom.lt/RPH16S)
...
|Hex ID (short code)|hexID|RPH16S|
