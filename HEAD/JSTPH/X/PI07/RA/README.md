...
* [RPH07R > JST PH (2 mm) 7 Pin Header Right Angle](#rph07r--jst-ph-2-mm-7-pin-header-right-angle)
	* [Symbols](#symbols)
...
NO IMAGE  
# RPH07R > JST PH (2 mm) 7 Pin Header Right Angle
...
- Short Link: [http://oom.lt/RPH07R](http://oom.lt/RPH07R)
...
[(Aliexpress) ](https://www.aliexpress.com/wholesale?SearchText=1117JST+PH+2+mm+7+Pin+Header+Right+Angle)&nbsp;&nbsp;&nbsp;[(Avnet) ](https://www.avnet.com/shop/us/search/JST+PH+2+mm+7+Pin+Header+Right+Angle)&nbsp;&nbsp;&nbsp;[(Digikey) ](https://www.digikey.co.uk/en/products/result?s=JST+PH+2+mm+7+Pin+Header+Right+Angle)&nbsp;&nbsp;&nbsp;[(LCSC) ](https://www.lcsc.com/search?q=JST+PH+2+mm+7+Pin+Header+Right+Angle)&nbsp;&nbsp;&nbsp;[(Farnell) ](https://uk.farnell.com/search?st=JST+PH+2+mm+7+Pin+Header+Right+Angle)&nbsp;&nbsp;&nbsp;[(Mouser) ](https://www.mouser.com/c/?q=JST+PH+2+mm+7+Pin+Header+Right+Angle)&nbsp;&nbsp;&nbsp;
## MPNs
...
|qrCode<br>[![](https://raw.githubusercontent.com/oomlout/oomlout_OOMP_parts_V2/main/HEAD/JSTPH/X/PI07/RA/qrCode_140.png)](https://github.com/oomlout/oomlout_OOMP_parts_V2/tree/main/HEAD/JSTPH/X/PI07/RA/qrCode.png)||||
| :---: | :---: | :---: | :---: |
...
|Hex ID (short code)|hexID|RPH07R|
