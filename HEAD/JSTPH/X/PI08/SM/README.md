...
* [RPH08S > JST PH (2 mm) 8 Pin Header (SMD)](#rph08s--jst-ph-2-mm-8-pin-header-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RPH08S > JST PH (2 mm) 8 Pin Header (SMD)
...
- Short Link: [http://oom.lt/RPH08S](http://oom.lt/RPH08S)
...
|Hex ID (short code)|hexID|RPH08S|
