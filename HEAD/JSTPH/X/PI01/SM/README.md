...
* [RPHPSM > JST PH (2 mm) 1 Pin Header (SMD)](#rphpsm--jst-ph-2-mm-1-pin-header-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RPHPSM > JST PH (2 mm) 1 Pin Header (SMD)
...
- Short Link: [http://oom.lt/RPHPSM](http://oom.lt/RPHPSM)
...
|Hex ID (short code)|hexID|RPHPSM|
