...
* [RPH20S > JST PH (2 mm) 20 Pin Header (SMD)](#rph20s--jst-ph-2-mm-20-pin-header-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RPH20S > JST PH (2 mm) 20 Pin Header (SMD)
...
- Short Link: [http://oom.lt/RPH20S](http://oom.lt/RPH20S)
...
|Hex ID (short code)|hexID|RPH20S|
