...
* [RPH02S > JST PH (2 mm) 2 Pin Header (SMD)](#rph02s--jst-ph-2-mm-2-pin-header-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RPH02S > JST PH (2 mm) 2 Pin Header (SMD)
...
- Short Link: [http://oom.lt/RPH02S](http://oom.lt/RPH02S)
...
|Hex ID (short code)|hexID|RPH02S|
