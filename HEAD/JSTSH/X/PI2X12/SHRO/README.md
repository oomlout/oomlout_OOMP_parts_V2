...
* [RSH2X12SHR > JST SH (1 mm) 24 Pin (2x12) Header Shrouded (IDC)](#rsh2x12shr--jst-sh-1-mm-24-pin-2x12-header-shrouded-idc)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X12SHR > JST SH (1 mm) 24 Pin (2x12) Header Shrouded (IDC)
...
- Short Link: [http://oom.lt/RSH2X12SHR](http://oom.lt/RSH2X12SHR)
...
|Hex ID (short code)|hexID|RSH2X12SHR|
