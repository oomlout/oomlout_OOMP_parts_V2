...
* [RSH5RS > JST SH (1 mm) 5 Pin Header Right Angle (SMD)](#rsh5rs--jst-sh-1-mm-5-pin-header-right-angle-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH5RS > JST SH (1 mm) 5 Pin Header Right Angle (SMD)
...
- Short Link: [http://oom.lt/RSH5RS](http://oom.lt/RSH5RS)
...
|Hex ID (short code)|hexID|RSH5RS|
