...
* [RSH2X08SHRR > JST SH (1 mm) 16 Pin (2x8) Header Shrouded (IDC) Right Angle](#rsh2x08shrr--jst-sh-1-mm-16-pin-2x8-header-shrouded-idc-right-angle)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X08SHRR > JST SH (1 mm) 16 Pin (2x8) Header Shrouded (IDC) Right Angle
...
- Short Link: [http://oom.lt/RSH2X08SHRR](http://oom.lt/RSH2X08SHRR)
...
|Hex ID (short code)|hexID|RSH2X08SHRR|
