...
* [RSH2X08S > JST SH (1 mm) 16 Pin (2x8) Header (SMD)](#rsh2x08s--jst-sh-1-mm-16-pin-2x8-header-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X08S > JST SH (1 mm) 16 Pin (2x8) Header (SMD)
...
- Short Link: [http://oom.lt/RSH2X08S](http://oom.lt/RSH2X08S)
...
|Hex ID (short code)|hexID|RSH2X08S|
