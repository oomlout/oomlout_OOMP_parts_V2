...
* [RSH2X08RS > JST SH (1 mm) 16 Pin (2x8) Header Right Angle (SMD)](#rsh2x08rs--jst-sh-1-mm-16-pin-2x8-header-right-angle-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X08RS > JST SH (1 mm) 16 Pin (2x8) Header Right Angle (SMD)
...
- Short Link: [http://oom.lt/RSH2X08RS](http://oom.lt/RSH2X08RS)
...
|Hex ID (short code)|hexID|RSH2X08RS|
