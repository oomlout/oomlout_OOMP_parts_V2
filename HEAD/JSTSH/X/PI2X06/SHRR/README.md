...
* [RSH2X06SHRR > JST SH (1 mm) 12 Pin (2x6) Header Shrouded (IDC) Right Angle](#rsh2x06shrr--jst-sh-1-mm-12-pin-2x6-header-shrouded-idc-right-angle)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X06SHRR > JST SH (1 mm) 12 Pin (2x6) Header Shrouded (IDC) Right Angle
...
- Short Link: [http://oom.lt/RSH2X06SHRR](http://oom.lt/RSH2X06SHRR)
...
|Hex ID (short code)|hexID|RSH2X06SHRR|
