...
* [RSH2X15RS > JST SH (1 mm) 30 Pin (2x15) Header Right Angle (SMD)](#rsh2x15rs--jst-sh-1-mm-30-pin-2x15-header-right-angle-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X15RS > JST SH (1 mm) 30 Pin (2x15) Header Right Angle (SMD)
...
- Short Link: [http://oom.lt/RSH2X15RS](http://oom.lt/RSH2X15RS)
...
|Hex ID (short code)|hexID|RSH2X15RS|
