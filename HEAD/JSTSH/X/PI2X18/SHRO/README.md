...
* [HSH2X18SHR > JST SH (1 mm) 36 Pin (2x18) Header Shrouded (IDC)](#hsh2x18shr--jst-sh-1-mm-36-pin-2x18-header-shrouded-idc)
	* [Symbols](#symbols)
...
NO IMAGE  
# HSH2X18SHR > JST SH (1 mm) 36 Pin (2x18) Header Shrouded (IDC)
...
|Hex ID (short code)|hexID|HSH2X18SHR|
