...
* [RSH2X09SHR > JST SH (1 mm) 18 Pin (2x9) Header Shrouded (IDC)](#rsh2x09shr--jst-sh-1-mm-18-pin-2x9-header-shrouded-idc)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X09SHR > JST SH (1 mm) 18 Pin (2x9) Header Shrouded (IDC)
...
- Short Link: [http://oom.lt/RSH2X09SHR](http://oom.lt/RSH2X09SHR)
...
|Hex ID (short code)|hexID|RSH2X09SHR|
