...
* [RSH2X20SHR > JST SH (1 mm) 40 Pin (2x20) Header Shrouded (IDC)](#rsh2x20shr--jst-sh-1-mm-40-pin-2x20-header-shrouded-idc)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X20SHR > JST SH (1 mm) 40 Pin (2x20) Header Shrouded (IDC)
...
- Short Link: [http://oom.lt/RSH2X20SHR](http://oom.lt/RSH2X20SHR)
...
|Hex ID (short code)|hexID|RSH2X20SHR|
