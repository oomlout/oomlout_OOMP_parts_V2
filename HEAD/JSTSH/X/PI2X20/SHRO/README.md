...
* [HSH2X20SHR > JST SH (1 mm) 40 Pin (2x20) Header Shrouded (IDC)](#hsh2x20shr--jst-sh-1-mm-40-pin-2x20-header-shrouded-idc)
	* [Symbols](#symbols)
...
NO IMAGE  
# HSH2X20SHR > JST SH (1 mm) 40 Pin (2x20) Header Shrouded (IDC)
...
[(Aliexpress) ](https://www.aliexpress.com/wholesale?SearchText=JST+SH+1+mm+40+Pin+2x20+Header+Shrouded+IDC)&nbsp;&nbsp;&nbsp;[(Avnet) ](https://www.avnet.com/shop/us/search/JST+SH+1+mm+40+Pin+2x20+Header+Shrouded+IDC)&nbsp;&nbsp;&nbsp;[(Digikey) ](https://www.digikey.co.uk/en/products/result?s=JST+SH+1+mm+40+Pin+2x20+Header+Shrouded+IDC)&nbsp;&nbsp;&nbsp;[(LCSC) ](https://www.lcsc.com/search?q=JST+SH+1+mm+40+Pin+2x20+Header+Shrouded+IDC)&nbsp;&nbsp;&nbsp;[(Farnell) ](https://uk.farnell.com/search?st=JST+SH+1+mm+40+Pin+2x20+Header+Shrouded+IDC)&nbsp;&nbsp;&nbsp;[(Mouser) ](https://www.mouser.com/c/?q=JST+SH+1+mm+40+Pin+2x20+Header+Shrouded+IDC)&nbsp;&nbsp;&nbsp;
## Images
  

|qrCode<br>[![](https://raw.githubusercontent.com/oomlout/oomlout_OOMP_parts_V2/main/HEAD/JSTSH/X/PI2X20/SHRO/qrCode_140.png)](https://github.com/oomlout/oomlout_OOMP_parts_V2/tree/main/HEAD/JSTSH/X/PI2X20/SHRO/qrCode.png)||||
| :---: | :---: | :---: | :---: |
...
|Full OOMP ID|oompID|HEAD-JSTSH-X-PI2X20-SHRO|
|Hex ID (short code)|hexID|HSH2X20SHR|
|name|name|JST SH (1 mm) 40 Pin (2x20) Header Shrouded (IDC)|
