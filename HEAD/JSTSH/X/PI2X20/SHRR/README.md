...
* [RSH2X20SHRR > JST SH (1 mm) 40 Pin (2x20) Header Shrouded (IDC) Right Angle](#rsh2x20shrr--jst-sh-1-mm-40-pin-2x20-header-shrouded-idc-right-angle)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X20SHRR > JST SH (1 mm) 40 Pin (2x20) Header Shrouded (IDC) Right Angle
...
- Short Link: [http://oom.lt/RSH2X20SHRR](http://oom.lt/RSH2X20SHRR)
...
|Hex ID (short code)|hexID|RSH2X20SHRR|
