...
* [HSH2R > JST SH (1 mm) 2 Pin Header Right Angle (SMD)](#hsh2r--jst-sh-1-mm-2-pin-header-right-angle-smd)
...
NO IMAGE  
# HSH2R > JST SH (1 mm) 2 Pin Header Right Angle (SMD)
...
- Short Link: [http://oom.lt/HSH2R](http://oom.lt/HSH2R)
