...
* [RSH02RS > JST SH (1 mm) 2 Pin Header Right Angle (SMD)](#rsh02rs--jst-sh-1-mm-2-pin-header-right-angle-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH02RS > JST SH (1 mm) 2 Pin Header Right Angle (SMD)
...
- Short Link: [http://oom.lt/RSH02RS](http://oom.lt/RSH02RS)
...
|Hex ID (short code)|hexID|RSH02RS|
