...
* [RSH2X16SHRR > JST SH (1 mm) 32 Pin (2x16) Header Shrouded (IDC) Right Angle](#rsh2x16shrr--jst-sh-1-mm-32-pin-2x16-header-shrouded-idc-right-angle)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X16SHRR > JST SH (1 mm) 32 Pin (2x16) Header Shrouded (IDC) Right Angle
...
- Short Link: [http://oom.lt/RSH2X16SHRR](http://oom.lt/RSH2X16SHRR)
...
|Hex ID (short code)|hexID|RSH2X16SHRR|
