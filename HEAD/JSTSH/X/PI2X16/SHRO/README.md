...
* [RSH2X16SHR > JST SH (1 mm) 32 Pin (2x16) Header Shrouded (IDC)](#rsh2x16shr--jst-sh-1-mm-32-pin-2x16-header-shrouded-idc)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X16SHR > JST SH (1 mm) 32 Pin (2x16) Header Shrouded (IDC)
...
- Short Link: [http://oom.lt/RSH2X16SHR](http://oom.lt/RSH2X16SHR)
...
|Hex ID (short code)|hexID|RSH2X16SHR|
