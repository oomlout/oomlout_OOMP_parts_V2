...
* [RSH2X14S > JST SH (1 mm) 28 Pin (2x14) Header (SMD)](#rsh2x14s--jst-sh-1-mm-28-pin-2x14-header-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X14S > JST SH (1 mm) 28 Pin (2x14) Header (SMD)
...
- Short Link: [http://oom.lt/RSH2X14S](http://oom.lt/RSH2X14S)
...
|Hex ID (short code)|hexID|RSH2X14S|
