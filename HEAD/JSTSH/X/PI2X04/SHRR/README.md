...
* [RSH2X04SHRR > JST SH (1 mm) 8 Pin (2x4) Header Shrouded (IDC) Right Angle](#rsh2x04shrr--jst-sh-1-mm-8-pin-2x4-header-shrouded-idc-right-angle)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X04SHRR > JST SH (1 mm) 8 Pin (2x4) Header Shrouded (IDC) Right Angle
...
- Short Link: [http://oom.lt/RSH2X04SHRR](http://oom.lt/RSH2X04SHRR)
...
|Hex ID (short code)|hexID|RSH2X04SHRR|
