...
* [RSH2X3SHRR > JST SH (1 mm) 6 Pin (2x3) Header Shrouded (IDC) Right Angle](#rsh2x3shrr--jst-sh-1-mm-6-pin-2x3-header-shrouded-idc-right-angle)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X3SHRR > JST SH (1 mm) 6 Pin (2x3) Header Shrouded (IDC) Right Angle
...
- Short Link: [http://oom.lt/RSH2X3SHRR](http://oom.lt/RSH2X3SHRR)
...
[(Aliexpress) ](https://www.aliexpress.com/wholesale?SearchText=1117JST+SH+1+mm+6+Pin+2x3+Header+Shrouded+IDC+Right+Angle)&nbsp;&nbsp;&nbsp;[(Avnet) ](https://www.avnet.com/shop/us/search/JST+SH+1+mm+6+Pin+2x3+Header+Shrouded+IDC+Right+Angle)&nbsp;&nbsp;&nbsp;[(Digikey) ](https://www.digikey.co.uk/en/products/result?s=JST+SH+1+mm+6+Pin+2x3+Header+Shrouded+IDC+Right+Angle)&nbsp;&nbsp;&nbsp;[(LCSC) ](https://www.lcsc.com/search?q=JST+SH+1+mm+6+Pin+2x3+Header+Shrouded+IDC+Right+Angle)&nbsp;&nbsp;&nbsp;[(Farnell) ](https://uk.farnell.com/search?st=JST+SH+1+mm+6+Pin+2x3+Header+Shrouded+IDC+Right+Angle)&nbsp;&nbsp;&nbsp;[(Mouser) ](https://www.mouser.com/c/?q=JST+SH+1+mm+6+Pin+2x3+Header+Shrouded+IDC+Right+Angle)&nbsp;&nbsp;&nbsp;
## MPNs
...
|qrCode<br>[![](https://raw.githubusercontent.com/oomlout/oomlout_OOMP_parts_V2/main/HEAD/JSTSH/X/PI2X03/SHRR/qrCode_140.png)](https://github.com/oomlout/oomlout_OOMP_parts_V2/tree/main/HEAD/JSTSH/X/PI2X03/SHRR/qrCode.png)||||
| :---: | :---: | :---: | :---: |
...
|Full OOMP ID|oompID|HEAD-JSTSH-X-PI2X03-SHRR|
|Hex ID (short code)|hexID|RSH2X3SHRR|
|name|name|JST SH (1 mm) 6 Pin (2x3) Header Shrouded (IDC) Right Angle|
