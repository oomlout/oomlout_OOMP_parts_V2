...
* [RSH2X19RS > JST SH (1 mm) 38 Pin (2x19) Header Right Angle (SMD)](#rsh2x19rs--jst-sh-1-mm-38-pin-2x19-header-right-angle-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH2X19RS > JST SH (1 mm) 38 Pin (2x19) Header Right Angle (SMD)
...
- Short Link: [http://oom.lt/RSH2X19RS](http://oom.lt/RSH2X19RS)
...
|Hex ID (short code)|hexID|RSH2X19RS|
