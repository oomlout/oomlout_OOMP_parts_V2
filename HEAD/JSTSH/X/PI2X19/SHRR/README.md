...
* [HSH2X19SHRR > JST SH (1 mm) 38 Pin (2x19) Header Shrouded (IDC) Right Angle](#hsh2x19shrr--jst-sh-1-mm-38-pin-2x19-header-shrouded-idc-right-angle)
	* [Symbols](#symbols)
...
NO IMAGE  
# HSH2X19SHRR > JST SH (1 mm) 38 Pin (2x19) Header Shrouded (IDC) Right Angle
...
|Hex ID (short code)|hexID|HSH2X19SHRR|
