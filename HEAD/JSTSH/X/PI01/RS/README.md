...
* [HSHPRS > JST SH (1 mm) 1 Pin Header Right Angle (SMD)](#hshprs--jst-sh-1-mm-1-pin-header-right-angle-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# HSHPRS > JST SH (1 mm) 1 Pin Header Right Angle (SMD)
...
|Hex ID (short code)|hexID|HSHPRS|
