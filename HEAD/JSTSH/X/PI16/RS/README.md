...
* [HSH16RS > JST SH (1 mm) 16 Pin Header Right Angle (SMD)](#hsh16rs--jst-sh-1-mm-16-pin-header-right-angle-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# HSH16RS > JST SH (1 mm) 16 Pin Header Right Angle (SMD)

- ID: HEAD-JSTSH-X-PI16-RS
- Hex ID: HSH16RS
- Name: JST SH (1 mm) 16 Pin Header Right Angle (SMD)
- Path: oomlout_OOMP_parts_V2/HEAD/JSTSH/X/PI16/RS/
...
- Short Link: [http://oom.lt/HSH16RS](http://oom.lt/HSH16RS)
...
[(Aliexpress) ](https://www.aliexpress.com/wholesale?SearchText=1117JST+SH+1+mm+16+Pin+Header+Right+Angle+SMD)&nbsp;&nbsp;&nbsp;[(Avnet) ](https://www.avnet.com/shop/us/search/JST+SH+1+mm+16+Pin+Header+Right+Angle+SMD)&nbsp;&nbsp;&nbsp;[(Digikey) ](https://www.digikey.co.uk/en/products/result?s=JST+SH+1+mm+16+Pin+Header+Right+Angle+SMD)&nbsp;&nbsp;&nbsp;[(LCSC) ](https://www.lcsc.com/search?q=JST+SH+1+mm+16+Pin+Header+Right+Angle+SMD)&nbsp;&nbsp;&nbsp;[(Farnell) ](https://uk.farnell.com/search?st=JST+SH+1+mm+16+Pin+Header+Right+Angle+SMD)&nbsp;&nbsp;&nbsp;[(Mouser) ](https://www.mouser.com/c/?q=JST+SH+1+mm+16+Pin+Header+Right+Angle+SMD)&nbsp;&nbsp;&nbsp;
## Images
  

|qrCode<br>[![](https://raw.githubusercontent.com/oomlout/oomlout_OOMP_parts_V2/main/HEAD/JSTSH/X/PI16/RS/qrCode_140.png)](https://github.com/oomlout/oomlout_OOMP_parts_V2/tree/main/HEAD/JSTSH/X/PI16/RS/qrCode.png)||||
| :---: | :---: | :---: | :---: |
...
|Hex ID (short code)|hexID|HSH16RS|
