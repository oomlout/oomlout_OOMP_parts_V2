...
* [RSH16RS > JST SH (1 mm) 16 Pin Header Right Angle (SMD)](#rsh16rs--jst-sh-1-mm-16-pin-header-right-angle-smd)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH16RS > JST SH (1 mm) 16 Pin Header Right Angle (SMD)
...
- Short Link: [http://oom.lt/RSH16RS](http://oom.lt/RSH16RS)
...
|Hex ID (short code)|hexID|RSH16RS|
