...
* [RSH16R > JST SH (1 mm) 16 Pin Header Right Angle](#rsh16r--jst-sh-1-mm-16-pin-header-right-angle)
	* [Symbols](#symbols)
...
NO IMAGE  
# RSH16R > JST SH (1 mm) 16 Pin Header Right Angle
...
- Short Link: [http://oom.lt/RSH16R](http://oom.lt/RSH16R)
...
|Hex ID (short code)|hexID|RSH16R|
