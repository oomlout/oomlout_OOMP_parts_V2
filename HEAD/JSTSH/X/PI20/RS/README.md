...
* [HSH20R > JST SH (1 mm) 20 Pin Header Right Angle (SMD)](#hsh20r--jst-sh-1-mm-20-pin-header-right-angle-smd)
...
NO IMAGE  
# HSH20R > JST SH (1 mm) 20 Pin Header Right Angle (SMD)
...
|Hex ID (short code)|hexID|HSH20R|
