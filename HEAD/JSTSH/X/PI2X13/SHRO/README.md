...
* [HSH2X13SHR > JST SH (1 mm) 26 Pin (2x13) Header Shrouded (IDC)](#hsh2x13shr--jst-sh-1-mm-26-pin-2x13-header-shrouded-idc)
	* [Symbols](#symbols)
...
NO IMAGE  
# HSH2X13SHR > JST SH (1 mm) 26 Pin (2x13) Header Shrouded (IDC)

- ID: HEAD-JSTSH-X-PI2X13-SHRO
- Hex ID: HSH2X13SHR
- Name: JST SH (1 mm) 26 Pin (2x13) Header Shrouded (IDC)
- Path: oomlout_OOMP_parts_V2/HEAD/JSTSH/X/PI2X13/SHRO/
...
- Short Link: [http://oom.lt/HSH2X13SHR](http://oom.lt/HSH2X13SHR)
...
|Hex ID (short code)|hexID|HSH2X13SHR|
